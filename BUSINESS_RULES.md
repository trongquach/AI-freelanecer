...
* **BR-USR-04 (Chính sách khóa tài khoản):** Hệ thống sẽ tự động khóa tài khoản (Suspend) trong 7 ngày nếu người dùng bị report vi phạm Tiêu chuẩn cộng đồng quá 3 lần trong vòng 1 tháng.
* **BR-USR-05 (Yêu cầu KYC):** Để thực hiện rút tiền hoặc nhận dự án có ngân sách trên 10,000 USD, AI Expert bắt buộc phải hoàn thành quy trình xác minh danh tính (eKYC).
...
* **BR-JOB-06 (Hết hạn Job):** Một Job Posting nếu không có bất kỳ Proposal nào được Accept trong vòng 30 ngày sẽ tự động bị đóng (Closed/Expired).
* **BR-JOB-07 (Rút Proposal):** AI Expert có thể tự động rút (Withdraw) Proposal của mình bất cứ lúc nào trước khi Client chọn Accept. Nếu đã Accept, việc hủy phải thông qua quy trình hủy dự án.
...
* **BR-SRV-03 (Duyệt Service):** Mọi AI Service mới được tạo bởi Expert phải qua vòng kiểm duyệt tự động (Auto-moderation) để phát hiện từ khóa nhạy cảm trước khi được hiển thị công khai (Published).
* **BR-SRV-04 (Giới hạn Service):** Một AI Expert không được phép có quá 15 AI Services ở trạng thái `Active` cùng lúc để đảm bảo chất lượng phục vụ và tránh spam nền tảng.
...
* **BR-PRJ-04 (Gia hạn thời gian):** Expert có thể gửi yêu cầu gia hạn thời gian (Extension Request) cho một Milestone. Yêu cầu này chỉ có hiệu lực khi Client bấm đồng ý (Approve) trên hệ thống.
* **BR-PRJ-05 (Hủy dự án):** Nếu Client yêu cầu hủy dự án khi Expert đang thực hiện, hai bên phải thỏa thuận tỷ lệ hoàn tiền. Nếu không thỏa thuận được trong vòng 3 ngày, hệ thống tự động chuyển dự án sang trạng thái Tranh chấp (Dispute).
...
* **BR-FIN-05 (Hạn mức rút tiền):** Số tiền rút (Withdraw) tối thiểu mỗi lần cho AI Expert là 50 USD và hệ thống chỉ xử lý lệnh rút tiền vào các ngày làm việc trong tuần.
* **BR-FIN-06 (Hoàn trả tiền - Refund Policy):** Tiền trong Escrow sẽ được hoàn trả (Refund) 100% cho Client nếu dự án bị hủy do Expert không có bất kỳ phản hồi hoặc cập nhật tiến độ nào trong vòng 5 ngày làm việc kể từ khi bắt đầu.
...
* **BR-REV-03 (Thời hạn đánh giá):** Client và Expert chỉ có quyền gửi Đánh giá (Review) trong vòng 14 ngày kể từ khi dự án được đánh dấu là `Completed`. Quá thời hạn này, tính năng Đánh giá sẽ bị khóa.
